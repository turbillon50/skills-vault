...
| `postgresql://*` | Neon / Postgres | `DATABASE_URL` |
| `APP_USR-*` | Mercado Pago (producción) | `MERCADOPAGO_ACCESS_TOKEN` |
| `TEST-*` (MP format) | Mercado Pago (sandbox) | `MERCADOPAGO_ACCESS_TOKEN` |
| `duffel_live_*` | Duffel (producción) | `DUFFEL_ACCESS_TOKEN` |
| `duffel_test_*` | Duffel (sandbox) | `DUFFEL_ACCESS_TOKEN` |
