...
- Complementa a qa-crew y code-review; no los reemplaza. Si chocan, mandan las reglas de Luis (build-verde-o-no-existe, qa-crew).
- Entregas a cliente: probado por el agente, se sube directo a produccion; no se espera aprobacion del cliente en preview.
- Node 20 obligatorio y commits firmados como turbillon50 <turbillon50@gmail.com>.
